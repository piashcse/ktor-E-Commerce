...
object Message {
    ...
    // Errors
    const val USER_NOT_EXIST = "User not found"
    const val PASSWORD_IS_WRONG = "Password is incorrect"
    const val TYPE_CAST_EXCEPTION = "Invalid data type provided"
    const val NULL_POINTER_ERROR = "An unexpected error occurred"
    const val INTERNAL_SERVER_ERROR = "Internal server error"
    const val UNAUTHORIZED_API_CALL = "Authentication required"
