...
class InventoryDAO(id: EntityID<String>) : BaseIntEntity(id, InventoryTable) {
    companion object : BaseIntEntityClass<InventoryDAO>(InventoryTable, InventoryDAO::class.java)
