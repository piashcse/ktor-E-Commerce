...
class CouponService : CouponRepository {
    override suspend fun createCoupon(request: CouponRequest): CouponResponse = query {
        CouponDAO.new {
            code = request.code
    ...
    override suspend fun updateCoupon(couponId: String, request: CouponRequest): CouponResponse = query {
    ...
    override suspend fun getCoupons(limit: Int, offset: Int): PaginatedResponse<CouponResponse> = query {
    ...
    private fun CouponDAO.toResponse() = CouponResponse(
        id = id.value,
        code = code,
